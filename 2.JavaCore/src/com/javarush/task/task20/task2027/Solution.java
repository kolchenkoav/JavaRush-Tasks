...
same - (1, 1) - (4, 1)
    ...
    public static List<Word> detectAllWords(int[][] crossword, String... words) {
        ...
        ArrayList<com.javarush.task.task20.task2027.Solution.Word> result = new ArrayList<>();
        ...
        for (String s : words) {
            ...
            for (int i = 0; i < ver; i++) {
                ...
                if (horLine.contains(s)) {
                    com.javarush.task.task20.task2027.Solution.Word word = new com.javarush.task.task20.task2027.Solution.Word(s);
